...
if __name__ == "__main__":
    print("running")
    # start = time.time()
    raster_file_path = "examples/SOM/datasets/NGA_population_v2_0_gridded/NGA_population_v2_0_gridded.tif"
    shape_file_path = "examples/SOM/datasets/geonetwork_landcover_nga_gc_adg/nga_gc_adg.shp"
